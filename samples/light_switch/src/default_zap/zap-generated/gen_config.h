...
#define MATTER_DM_TEMPERATURE_CONTROLLED_CABINET_TOPOLOGY_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_ELECTRICAL_ALARM_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_ELECTRICAL_DISTRIBUTION_CLUSTER_SERVER_ENDPOINT_COUNT (0)
#define MATTER_DM_ELECTRICAL_PROTECTION_ALARM_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_HUMIDISTAT_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_AV_ANALYSIS_CLUSTER_SERVER_ENDPOINT_COUNT (0)
...
#define MATTER_DM_TEMPERATURE_CONTROLLED_CABINET_TOPOLOGY_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_ELECTRICAL_ALARM_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
#define MATTER_DM_ELECTRICAL_DISTRIBUTION_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
#define MATTER_DM_ELECTRICAL_PROTECTION_ALARM_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_HUMIDISTAT_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_DYNAMIC_LIGHTING_CLUSTER_CLIENT_ENDPOINT_COUNT (0)
...
#define MATTER_DM_AV_ANALYSIS_CLUSTER_CLIENT_ENDPOINT_COUNT (0)

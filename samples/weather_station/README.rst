...
.. note::
   ...
   To receive logs from the device, connect to it through RTT.
...
Advertising over Bluetooth LE and DFU start automatically and **LED** starts blinking blue (short flash on).
